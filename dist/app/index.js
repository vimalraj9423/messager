...
app.get('/', function (req, res) {
  var data = (0, _db.executeQueryAndDisconnect)(_queries.QUERY_ADMIN_MECHANIC).then(function (data) {
    return data.map(function (x) {
      return x.shop_name;
    });
  });
  var markup = data.then(function (ListComp) {
    return (0, _server.renderToString)(_react2.default.createElement(_components.Home, { data: ListComp }));
  });
