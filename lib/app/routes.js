...
router.post('/insertForm', function(req, res) {
  const QUERY_INSERT =
    "INSERT INTO temp_test (name) VALUES ('" + req.body.name + "')"
  executeQueryAndDisconnect(QUERY_INSERT).then(_ =>
    console.log('inserted val')
  )
  // const QUERY_ADMIN_MECHANIC = 'select * from temp_test ORDER BY user_id DESC LIMIT 0,1'
