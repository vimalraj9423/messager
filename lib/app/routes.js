...
import { formCss } from '../components/formSCss'
import {
  Swipeables,
  SwipeableTemplate,
  formElem,
...
router.get('/form', function(req, res) {
  ...
  console.log(renderToString(sheet.collectStyles(<formElem />)))
  const markup = renderToString(sheet.collectStyles(<formElem />))
